...
- Official CapCut text templates, including キラキラ変身, are optional. Host-editor captions, ChatCut captions, and custom Motion Graphics are valid when they are centered, non-duplicated, fully inside the visible safe area, and prominent (heavy weight, thick dark stroke, contrast band).
