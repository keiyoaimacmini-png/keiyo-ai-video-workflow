...
| Editor of record cannot emit official Holiday Twist | Confirm frozen preset, case editor identity, and that picture has not been imported to CapCut | Generate once on official CapCut Text to Speech (frozen lines, blank-line bulk paste), download, import audio into the editor of record. Do not offer a substitute voice, a voice reopen, or a new CapCut case | Official preset audio exists as a working copy in the editor of record |
