...
- Gemini Web script draft on the current host's Chrome, with no API key and no copied browser session between a Cloud Agent VM and the operator physical machine;
