...
- Gemini 3.8 Flash script draft on this Mac via Antigravity CLI (`agy --print`), sent by the agent in the same turn, with no API key, no AI Credit overages, no Cursor parent-model switch, and no operator paste;
