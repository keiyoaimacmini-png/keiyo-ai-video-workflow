...
- `$PROJECT_ROOT/.cursor/skills/product-video/scripts/semantic_material_match.py`
...
- `$PROJECT_ROOT/.cursor/skills/produce-tiktok-product-video-portable/scripts/purge_local_working_media.py`
