...
| Portable Gemini paste | `render_gemini_web_prompt.py` |
| Rule snapshot (portable) | `build_rule_snapshot.py` |
| Bulk TTS gaps (legacy split only) | `prepare_bulk_tts_scene_gaps.py` |
| CapCut result-card audio | `capture_capcut_result_audio.py` |
